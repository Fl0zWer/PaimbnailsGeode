...
- <cg>**New Logo**</c>: Paimbnails has a <cy>brand new logo</c>! Fresh look, same great mod.
- <cg>**Dynamic Popup**</c>: Added a new <cy>Dynamic Popup</c> system with smooth animations — popups now feel way more polished and alive.

**Bug Fixes & Improvements**

- <cg>**Better Stability**</c>: Fixed several <cy>random crashes</c> that could happen when closing popups or switching screens.
- <cg>**Smoother on All Platforms**</c>: Improved <cy>compatibility with Android, iOS, and macOS</c> so the mod works better everywhere.
- <cg>**Fewer Conflicts with Other Mods**</c>: Internal changes to <cy>play nicer with other Geode mods</c> you might have installed.
- <cg>**Source Code Available**</c>: The mod's <cy>source code</c> is now linked in the mod info for anyone curious.
...
- <cg>**More Stable Than Ever**</c>: A <cy>full code audit</c> was performed across every file in the mod to ensure everything works correctly with zero crashes.
- <cg>**Better Performance**</c>: <cy>Memory management</c> has been optimized throughout the entire mod — less RAM usage and zero memory leaks.
- <cg>**Fewer Mod Conflicts**</c>: <cy>Compatibility with popular mods</c> has been verified following Geode SDK best practices.
- <cg>**Faster Loading**</c>: <cy>Thumbnails, profile images, and GIFs</c> now load and cache more efficiently.

**Internal Improvements**

- <cp>**C++23**</c>: The mod now uses the <cy>latest C++ standard</c>, enabling faster future development and safer code.
- <cp>**New Networking System**</c>: A <cy>modern HTTP request system</c> was added for smoother downloads and server communication.
- <cp>**Better Cross-Platform Support**</c>: Internal improvements for <cy>better performance on Android, iOS, and macOS</c>.

**Documentation**

- <cy>**Improved Support Page**</c>: The in-game <cg>help section</c> now includes common issues, how to report bugs, and known issues.

---

# v2.2.1

**Corrections and Changes / Correcciones y Cambios**

- <cy>**Edit Layers - Beta Warning**</c>: The <cg>Edit Layers</c> button now shows a <cr>warning popup</c> before opening. This feature is still in <cy>beta</c> and may have bugs. You must confirm before using it.
- <cy>**Cross-Platform Support**</c>: Paimbnails is now <cg>compatible with all platforms</c> (Android, iOS, and macOS).
- <cy>**Stability Improvements**</c>: General <cg>fixes and improvements</c> for a more stable experience.
