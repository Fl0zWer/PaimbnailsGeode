...
<body>
    ...
    <div class="container">
        ...
        <div class="nav-grid">
            ...
            <a href="/donate" class="nav-card">
                <div class="nav-icon" style="color: #ec4899; background: rgba(236,72,153,0.1);">
                ...
                <div class="nav-title">Donate</div>
                <div class="nav-desc">Support the project on Ko-fi and help keep the servers running.</div>
            </a>
        </div>
