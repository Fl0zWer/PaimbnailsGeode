                    ...
                    for (auto* node : CCArrayExt<CCNode*>(children)) {
                        ...
                        for (auto* menuNode : CCArrayExt<CCNode*>(menuChildren)) {
                            ...
                            if (!isViewButton) {
                                ...
                                if (id == "view-button" || id == "paimon-view-button" || id == "paimon-view-button"_spr) {
                                    isViewButton = true;
                                }
                            }
                            ...
                            if (isViewButton) {
                                ...
                                if (menuItem->getID() == "paimon-view-button" || menuItem->getID() == "paimon-view-button"_spr) {
                    ...
                    if (!fields->m_viewOverlay) {
                        ...
                        while (!stack.empty()) {
                            ...
                            if (auto menuItem = geode::cast::typeinfo_cast<CCMenuItemSpriteExtra*>(cur)) {
                                ...
                                std::string id = menuItem->getID();
                                if (id == "view-button" || id == "main-button" || id == "paimon-view-button" || id == "paimon-view-button"_spr) isViewButton = true;
...
#else
            // En movil: mostrar siempre el GIF animado (no hay hover)
