...
void PaimonSupportLayer::createBenefitsPanel() {
    ...
    std::vector<Benefit> benefits = {
        ...
        {"GJ_heart_001.png",          "Early Access Before Public",     {255, 100, 150}},
    };
...
void PaimonSupportLayer::createThankYouSection() {
    ...
    // corazoncito
    auto heart = CCSprite::createWithSpriteFrameName("GJ_heart_001.png");
    if (heart) {
        heart->setScale(0.4f);
...
void PaimonSupportLayer::createButtons() {
    ...
    auto heartIcon = CCSprite::createWithSpriteFrameName("GJ_heart_001.png");
    if (heartIcon) {
